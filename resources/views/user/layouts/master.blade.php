        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            <div class="col-lg-4">
                <a href="" class="text-decoration-none">
                    <span class="h1 text-uppercase text-warning bg-dark px-2">Relax</span>
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    <a href="" class="text-decoration-none d-block d-lg-none">
                        <span class="h1 text-uppercase text-dark bg-warning px-2">Relax</span>
                        <span class="h1 text-uppercase text-warning  px-2 ml-n1">Shop</span>
                    </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="{{ route('user#cart') }} " class="nav-item nav-link">My
                                Cart</a>
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            <div class="btn-group m-1">
                                <button type="button" class="btn btn-light btn-lg dropdown-toggle"
                                    data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">

                                    @if (Auth::user()->image == null)
                                        @if (Auth::user()->gender == 'female')
                                            <img src="{{ asset('images/default-female.jpg') }} " style="width: 30px"
                                                alt="user" />
                                        @else
                                            <img src="{{ asset('images/Default-welcomer.png') }}" style="width: 30px"
                                                alt="user" />
                                        @endif
                                    @else
                                        <img src="{{ asset('storage/' . Auth::user()->image) }}" style="width: 30px"
                                            alt="user image">
                                    @endif

                                    <span class="name" value="{{ Auth::user()->id }} ">
                                        {{ Str::title(Auth::user()->name) }}</span>
                                </button>
                                <ul class="dropdown-menu dropdown-menu-lg-end mt-2">
                                    <li><a class="dropdown-item h5" href="{{ route('user#account') }} "><i
                                                class="fa fa-user me-3" aria-hidden="true"></i>
                                            Account</a></li>
                                    <li><a class="dropdown-item h5" href="{{ route('user#changePasswordPage') }}"><i
                                                class="fa-solid fa-key me-3"></i>Change password</a></li>
                                    <hr>
                                    <li class="">
                                        <form action="{{ route('logout') }} " method="post">
                                            @csrf
                                            <button type="submit" class="dropdown-item btn "> <i
                                                    class="fa-solid fa-power-off me-4"></i>Logout
                                            </button>
                                        </form>
                                    </li>
                                </ul>

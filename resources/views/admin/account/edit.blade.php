...
@section('content')
    <div class="row ">
        ...
        <div class="col-2 offset-9  px-5">
            <a href="{{ route('admin#info') }}"><button class="btn bg-dark px-3 text-white  mb-3"><i
    ...
    <div class="col-lg-8 offset-2 pb-5">
        <div class="card">
            <div class="card-body">
                ...
                <hr>
                <form action=" {{ route('admin#update', Auth::user()->id) }} " method="post" novalidate="novalidate"
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 offset-1">
                            ...
                            <div class="form-group py-1">
                                <label
                                    class="control-label mb-1 h5 @error('gender')
                                    is-invalid
